...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { en_in_n }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { en_out }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
