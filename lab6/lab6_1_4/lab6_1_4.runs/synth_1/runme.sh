...
HD_PWD='/home/tao/DCE/lab6/lab6_1_4/lab6_1_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_in_serial_out_load_enable_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_in_serial_out_load_enable_behavior.tcl
