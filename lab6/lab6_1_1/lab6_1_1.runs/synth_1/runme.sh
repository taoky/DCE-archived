...
HD_PWD='/home/tao/DCE/lab6/lab6_1_1/lab6_1_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_with_synch_reset_load_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_with_synch_reset_load_behavior.tcl
