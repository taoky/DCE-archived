...
ISEStep( "vivado",
         "-log register_with_synch_reset_load_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_with_synch_reset_load_behavior.tcl" );
