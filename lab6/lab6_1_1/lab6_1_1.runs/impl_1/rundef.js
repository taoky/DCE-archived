...
ISEStep( "vivado",
         "-log register_with_synch_reset_load_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_with_synch_reset_load_behavior.tcl -notrace" );
