...
HD_PWD='/home/tao/DCE/lab6/lab6_1_2/lab6_1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_with_synch_reset_set_load_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_with_synch_reset_set_load_behavior.tcl -notrace
