...
#
# Generated by export_simulation on Sun Nov 18 23:51:53 CST 2018
#
################################################################################
...
'-reset_run' switch to the './c_counter_binary_10.sh' script.

./c_counter_binary_10.sh -reset_run
...
./c_counter_binary_10.sh -noclean_files

For more information on the script, please type './c_counter_binary_10.sh -help'.
