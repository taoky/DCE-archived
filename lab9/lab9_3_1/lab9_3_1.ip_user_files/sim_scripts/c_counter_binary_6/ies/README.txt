...
#
# Generated by export_simulation on Sat Nov 17 21:03:14 CST 2018
#
################################################################################
...
'-reset_run' switch to the './c_counter_binary_6.sh' script.

./c_counter_binary_6.sh -reset_run
...
./c_counter_binary_6.sh -noclean_files

For more information on the script, please type './c_counter_binary_6.sh -help'.
