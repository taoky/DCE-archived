...
#
# Generated by Vivado on Sat Nov 17 22:35:54 CST 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../lab9_3_1.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../lab9_3_1.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../lab9_3_1.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/tao/DCE/lab9/lab9_3_1/lab9_3_1.cache/compile_simlib/vcs"
  fi
