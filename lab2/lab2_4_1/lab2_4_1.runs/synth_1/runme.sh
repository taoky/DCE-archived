...
HD_PWD='/home/tao/DCE/lab2/lab2_4_1/lab2_4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rca_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rca_dataflow.tcl
