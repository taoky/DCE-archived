...
HD_PWD='/home/tao/DCE/lab2/lab2_4_1/lab2_4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rca_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rca_dataflow.tcl -notrace
