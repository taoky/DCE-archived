...
HD_PWD='/home/tao/DCE/lab5/lab5_1_1/lab5_1_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SR_latch_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SR_latch_dataflow.tcl -notrace
