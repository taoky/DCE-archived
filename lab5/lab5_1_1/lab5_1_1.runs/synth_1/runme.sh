...
HD_PWD='/home/tao/DCE/lab5/lab5_1_1/lab5_1_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SR_latch_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SR_latch_dataflow.tcl
