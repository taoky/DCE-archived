...
ISEStep( "vivado",
         "-log D_ff_with_ce_and_synch_reset_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_ff_with_ce_and_synch_reset_behavior.tcl -notrace" );
