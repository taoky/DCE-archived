...
HD_PWD='/home/tao/DCE/lab5/lab5_2_4/lab5_2_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_ff_with_ce_and_synch_reset_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_ff_with_ce_and_synch_reset_behavior.tcl -notrace
