...
HD_PWD='/home/tao/DCE/lab5/lab5_2_5/lab5_2_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T_ff_enable_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T_ff_enable_behavior.tcl -notrace
