...
HD_PWD='/home/tao/DCE/lab5/lab5_2_5/lab5_2_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_ff_enable_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_ff_enable_behavior.tcl
