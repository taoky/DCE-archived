...
HD_PWD='/home/tao/DCE/lab5/lab5_1_2/lab5_1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gated_SR_latch_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gated_SR_latch_dataflow.tcl -notrace
