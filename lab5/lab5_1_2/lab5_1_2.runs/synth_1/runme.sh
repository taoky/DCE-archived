...
HD_PWD='/home/tao/DCE/lab5/lab5_1_2/lab5_1_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gated_SR_latch_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gated_SR_latch_dataflow.tcl
