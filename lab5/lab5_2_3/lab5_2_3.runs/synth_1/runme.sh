...
HD_PWD='/home/tao/DCE/lab5/lab5_2_3/lab5_2_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_ff_with_synch_reset_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_ff_with_synch_reset_behavior.tcl
