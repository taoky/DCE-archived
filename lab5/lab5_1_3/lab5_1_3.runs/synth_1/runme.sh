...
HD_PWD='/home/tao/DCE/lab5/lab5_1_3/lab5_1_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_latch_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_latch_dataflow.tcl
