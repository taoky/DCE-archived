...
HD_PWD='/home/tao/DCE/lab5/lab5_1_3/lab5_1_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_latch_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_latch_dataflow.tcl -notrace
